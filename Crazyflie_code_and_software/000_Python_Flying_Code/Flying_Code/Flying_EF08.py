...
class Fly_EF08:
    ...
    def land(self):
        ...
        self._cf.param.add_update_callback(group="pid_attitude", name="pitch_kd", cb=self.param_updated_callback)
        self.perch()
    ...
    def param_updated_callback(self, name, value):
        print ("%s has value %s" % (name, value))
    # MAIN LOOP
